...
public class TextTyper : MonoBehaviour
{
    ...
    private bool text_closed = true;
    private bool isFading = false; // Флаг, показывающий, идет ли затухание фона
    private bool isInitialFading = false; // Флаг, показывающий, идет ли затухание initialImage
    ...
    void Start()
    {
        ...
        StartCoroutine(TypeText(textBlocks[currentBlockIndex]));
    ...
    void Update()
    {
        // Игнорируем нажатия, пока идет затухание
        if (isFading || isInitialFading)
        {
            return;
        }
    ...
    {
        isFading = true; // Устанавливаем флаг, что идет затухание
        ...
        isFading = false; // Сбрасываем флаг, когда затухание закончилось
    }

    IEnumerator FadeInFirstElements()
    {
        isInitialFading = true; // Устанавливаем флаг, что идет затухание initialImage
        ...
        isInitialFading = false; // Сбрасываем флаг, когда затухание initialImage закончилось
    }
